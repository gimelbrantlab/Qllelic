...
```
Installation takes less than 1 minute. To install a sprevious versions: `devtools::install_github("gimelbrantlab/QCumber@v0.3.1")`, please take into account that it had different name.
