# Getting help with AIQC

Thanks for using AIQC. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/AIQC/issues) to make sure the 
